...
def update_portfolio():
    ...
    closed_positions = [] # 只存平倉與配息 (用於舊版表格)
    ledger = []           # 新增：完整流水帳 (含買入)
    history_data = []
    ...
    print("更新完成 (含 Transaction Ledger)")
