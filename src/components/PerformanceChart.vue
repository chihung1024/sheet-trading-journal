...
/* 圖表畫布 */
.canvas-box { flex-grow: 1; position: relative; width: 100%; min-height: 300px; } /* 增加最小高度 */
...
@media (max-width: 768px) {
    ...
    .toggle-pills-scroll { width: 100%; } /* 讓 Pills 佔滿寬度並可滑動 */
    .toggle-pills { width: max-content; } /* 內容寬度 */
